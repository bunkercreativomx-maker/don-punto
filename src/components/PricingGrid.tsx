            ...
            <div className="w-full overflow-x-auto pb-4 custom-scrollbar bg-slate-950/40 rounded-2xl border border-white/5 shadow-2xl">
                <div className="min-w-[2200px]">
                    {rows.length > 0 ? (
                        <>
                            {/* Table Header */}
                            <div className="grid grid-cols-[140px_220px_90px_120px_120px_100px_120px_110px_100px_110px_120px_110px_110px_110px_110px_110px_110px_110px_140px_60px] gap-3 px-6 py-5 bg-slate-900 border-b border-white/10 text-[10px] font-black text-slate-500 uppercase tracking-widest items-center sticky top-0 z-10">
                                ...
                                <div className="text-right text-white">UNIT. SUGERIDO</div>
                                <div className="text-right">BRUTO TOTAL</div>
                                ...
                                <div className="text-right text-rose-400/70">ENVÍO</div>
                                <div className="text-right text-rose-400/70">COMISIÓN</div>
                                <div className="text-right text-rose-400/70">IVA COM.</div>
                                <div className="text-right">BASE GRAV.</div>
                                <div className="text-right text-rose-400/70">IVA RET.</div>
                                <div className="text-right text-rose-400/70">ISR RET.</div>
                                <div className="text-right">CEDULAR</div>
                                <div className="text-right text-yellow-500 bg-yellow-500/5 py-1 px-2 rounded border border-yellow-500/10 text-center">NETO APP</div>
                            ...
                            <div className="divide-y divide-white/5">
                                {rows.map((row) => {
                                    ...
                                    return (
                                        <div key={row.id} className="grid grid-cols-[140px_220px_90px_120px_120px_100px_120px_110px_100px_110px_120px_110px_110px_110px_110px_110px_110px_110px_140px_60px] gap-3 px-6 py-4 hover:bg-slate-800/40 transition-colors items-center font-mono text-xs text-slate-300">
                                            
                                            {/* 1. Target Profit Input */}
                                            <div>
